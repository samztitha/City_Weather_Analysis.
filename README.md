...
This repository contains an R Markdown (`.Rmd`) file and dataset for analyzing and comparing weather data across multiple cities.
...
* `city_weather.csv` — Dataset (sample: Chennai, Madurai, Coimbatore)
...
* Line graph: Temperature trends over time (all cities)
